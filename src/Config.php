...
class Config
{
     ...
     */
    private $models = [
        \Ar3s\Exchange1C\Interfaces\GroupInterface::class   => null,
        \Ar3s\Exchange1C\Interfaces\ProductInterface::class => null,
        \Ar3s\Exchange1C\Interfaces\OfferInterface::class   => null,
    ];
