...
use Ar3s\Exchange1C\Events\AfterProductsSync;
use Ar3s\Exchange1C\Events\AfterUpdateProduct;
use Ar3s\Exchange1C\Events\BeforeProductsSync;
use Ar3s\Exchange1C\Events\BeforeUpdateProduct;
